...
public class GerarClasseGUI {
    ...
    public GerarClasseGUI(String nomeDaClasse, List<Atributo> listaDeAtributos, String[] foreignKey) {
        ...
        if (listaDeAtributos.get(tamanho).getNome().equals("caminho")) {
            codigoGerado.add("private JPanel pnCentro = new JPanel(new GridLayout(" + (listaDeAtributos.size() - 2) + ", 2));");
        } else {
        ...
        codigoGerado.add("private JPanel pnE1 = new JPanel(new FlowLayout(FlowLayout.CENTER));");
        codigoGerado.add("private JPanel pnE2 = new JPanel(new FlowLayout(FlowLayout.CENTER));");
        codigoGerado.add("private JPanel pnE3 = new JPanel(new GridLayout(1, 1));");
        for (int i = 0; i < listaDeAtributos.size(); i++) {
            if (listaDeAtributos.get(i).getNome().equals("caminho")) {
            } else {
        ...
        codigoGerado.add("JTextField tfCaminho = new JTextField();");
        ...
        codigoGerado.add("private JPanel pnEsquerda = new JPanel(new BorderLayout());\n"
        ...
        codigoGerado.add("private String caminho;\n"
        ...
        codigoGerado.add("btAbrirImagem.setEnabled(false);");
        codigoGerado.add("tfCaminho.setEditable(false);");
        for (int i = 1;
        ...
        codigoGerado.add("tfCaminho.setText(\"\");");
        for (int i = 1; i < listaDeAtributos.size(); i++) {
            if ((listaDeAtributos.get(i).getNome().substring(listaDeAtributos.get(i).getNome().length() - 1, listaDeAtributos.get(i).getNome().length())).equals("K")) {
        ...
        codigoGerado.add("caminho = " + classeMe + ".getCaminho();\n"
                + "tfCaminho.setText(caminho);\n"
        ...
        for (int i = 0; i < listaDeAtributos.size(); i++) {
            if ((listaDeAtributos.get(i).getNome().substring(listaDeAtributos.get(i).getNome().length() - 1, listaDeAtributos.get(i).getNome().length())).equals("K")) {
                ...
                codigoGerado.add("cb" + sT.primeiraLetraMaiuscula(listaDeAtributos.get(i).getNome()) + ".setEnabled(false);");
            } else if (listaDeAtributos.get(i).getNome().equals("caminho")) {
        ...
        codigoGerado.add("btAbrirImagem.setEnabled(true);");
        codigoGerado.add("}\n"
                + "});\n"
        ...
        codigoGerado.add("caminho = tfCaminho.getText();");
        codigoGerado.add(classeMe + ".setCaminho(caminho);");
        codigoGerado.add("caminho = \"\";");
        codigoGerado.add("icone = new ImageIcon(caminho);");
        codigoGerado.add("rotulo.setIcon(icone);");
        ...
        codigoGerado.add("String caminho = \"\";\n");
        codigoGerado.add("icone = new ImageIcon(caminho);\n"
                + "rotulo.setIcon(icone);\n");
        codigoGerado.add(
                "tfCaminho.setText(\"\");");
        ...
        for (int i = 0;
            ...
            if (listaDeAtributos.get(i).getTipo().equals("Date")) {
                codigoGerado.add("btEscolha" + i + ".addActionListener(new ActionListener() {\n"
                        ...
                        + "try {\n"
                        + "jTextArea.setText(\"\");\n"
                        + "DateChooser dc" + i + " = new DateChooser((JFrame) null, \"Escolha uma data\");\n"
                        + "data" + i + " = dc" + i + ".select();\n"
        ...
        codigoGerado.add(
                "tf" + sT.primeiraLetraMaiuscula(listaDeAtributos.get(0).getNome()) + ".addActionListener(new ActionListener() {\n"
                + "@Override\n"
                + "public void actionPerformed(ActionEvent e) {\n"
